...
//
// #route:"GET /"#
func (Group) ItemList(_offset_1 int /* #name:"offset"# */, _limit_1 int /* #name:"limit"# */) (_items []*ItemWithID /* #name:"items"# */, err error /* #name:"err"# */) {
	var __offset_1 string
	var __limit_1 string

	__offset_1 = strconv.FormatInt(int64(_offset_1), 10)

	__limit_1 = strconv.FormatInt(int64(_limit_1), 10)

	resp, err := Client.Clone().
		SetQuery("offset", __offset_1).
		SetQuery("limit", __limit_1).
		Get("group/item")
	if err != nil {
		return nil, err
	}
...
//
// #route:"GET /"#
func (Group) MiddList(_xToken string /* #in:"header" name:"x-token"# */, _offset_2 int /* #name:"offset"# */, _limit_2 int /* #name:"limit"# */) (_midds []*MiddWithID /* #name:"midds"# */, err error /* #name:"err"# */) {
	var __offset_2 string
	var __limit_2 string

	__offset_2 = strconv.FormatInt(int64(_offset_2), 10)

	__limit_2 = strconv.FormatInt(int64(_limit_2), 10)

	resp, err := Client.Clone().
		SetQuery("offset", __offset_2).
		SetQuery("limit", __limit_2).
		Get("group/midd")
	if err != nil {
		return nil, err
	}
...
//
// #route:"GET /"#
func (ItemService) List(_offset_1 int /* #name:"offset"# */, _limit_1 int /* #name:"limit"# */) (_items []*ItemWithID /* #name:"items"# */, err error /* #name:"err"# */) {
	var __offset_1 string
	var __limit_1 string
...
//
// #route:"GET /"#
func (MiddService) List(_xToken string /* #in:"header" name:"x-token"# */, _offset_2 int /* #name:"offset"# */, _limit_2 int /* #name:"limit"# */) (_midds []*MiddWithID /* #name:"midds"# */, err error /* #name:"err"# */) {
	var __offset_2 string
	var __limit_2 string
